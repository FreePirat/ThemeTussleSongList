...
@WebServlet(name = "SongDeleteServlet", value = "/delete-song")
public class SongDeleteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        getServletContext().getRequestDispatcher("/song/delete.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //remove any PlaylistItems that use that song
        PlaylistItemDAO piDAO = new PlaylistItemDAO();
        piDAO.makeConnection();
        List<PlaylistItem> piList = piDAO.findAll();
        for(PlaylistItem cartItem : piList){
            if(cartItem.getSong().getId() == id){
                piDAO.delete(id);
            }
        }
